  ...
  const steps = [
    {
      ...
      description: "Schedule a consultation with our team to set up your customized corporate account with tailored pricing.",
      bullets: [
      ...
      image: "/images/howitworks1.jpg"
    },
    {
      icon: <ClipboardCheck size={28} className="text-white" />,
      title: "Add Team Members",
      description: "Invite employees to the platform and set travel policies, approval workflows, and spending limits.",
      bullets: [
    ...
    },
    {
      ...
      title: "Book & Manage Transfers",
      description: "Easily book and track airport transfers for all your team members through our intuitive dashboard.",
      bullets: [
        "Flight integration",
      ...
      image: "/images/howitworks3.jpg"
    }
  ];

  return (
    <section id="how-it-works" className="py-24 bg-gradient-to-b from-background via-primary/5 to-background relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Get your entire organization set up with our airport transfer service in three simple steps.
          </motion.p>
        </motion.div>
        ...
        >
          <div className="flex flex-col lg:flex-row gap-10">
            <div className="lg:w-1/2 order-2 lg:order-1">
              ...
              <div className="mb-10">
                <h4 className="font-semibold mb-4 text-text">Key Features:</h4>
