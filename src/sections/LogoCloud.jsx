...
const LogoCloud = () => {
  ...
  const companies = [
    { name: "IBM", logo: "/images/ibm.jpg" },
    { name: "ITC", logo: "/images/itc.png" },
    { name: "Swiggy", logo: "/images/swiggy.png" },
    { name: "TCS", logo: "/images/tcs.png" },
    { name: "Reliance", logo: "/images/reliance.jpg" },
  ...
  return (
    <section className="py-16 sm:py-24 relative overflow-hidden bg-gradient-to-b from-background to-background/90">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h3 className="text-2xl sm:text-3xl font-bold text-text bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent inline-block">
