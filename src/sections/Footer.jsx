...
const Footer = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      content: "corporate@airportcabpro.com",
      href: "mailto:corporate@airportcabpro.com"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <span className="ml-3 text-2xl font-bold text-white">AirportCab<span className="text-accent">Pro</span></span>
            </div>
            ...
            <div className="mt-8 p-5 bg-white/10 rounded-xl">
              ...
              <div className="flex">
                <input
                  ...
                  autoComplete="email"
                  className="flex-grow px-4 py-2 bg-white/20 rounded-l-lg text-white placeholder:text-white/50 focus:outline-none"
                />
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/50 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} AirportCabPro. All rights reserved.
          </p>
